...
public class JQPLQueryTest {
    ...
    // JUnit test for find By Name Or Description SQL Named Param
    @Test
    @DisplayName("JUnit test for find By Name Or Description SQL Named Param")
    public void givenProductNameAndDescription_whenFindByNameOrDescriptionSQLNamedParam_thenReturnProductObject() {
        ...
        // when - action or the behavior that we are going test
        List<Product> products = productRepository.findByNameOrDescriptionSQLNamedParam(name,description);
